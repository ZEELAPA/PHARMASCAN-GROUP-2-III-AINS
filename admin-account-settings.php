...
<html lang="en">
    ...
    <link rel="stylesheet" href="styles/admin-account-settings.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="styles/global.css?v=<?php echo time(); ?>">
    <title>Admin Account Settings | PharmaScan</title>
                ...
                <div class="panels-container">
                    ...
                    <div class="options-panel">
                        ...
                        <div class="options-container">
                            <a href="admin-profile-settings.php" class="options">Profile Information</a>
                            <a href="admin-account-settings.php" class="options active">Account Settings</a>
