document.addEventListener('DOMContentLoaded', function() {
    ...
    const openModalAsEdit = (card) => {
        ...
        // NEW: Show archive button in Edit mode
        if(archiveButton) {
    ...
    const openModalAsAdd = () => {
        ...
        // NEW: Hide archive button in Add mode
        if(archiveButton) {
    ...
    if (archiveButton) {
        archiveButton.addEventListener('click', () => {
            ...
            if (!taskID) {
                alert("Error: Task ID is missing for archiving.");
                return;
            }
            ...
            if (confirm("Are you sure you want to archive this task? It will be permanently removed from the active task list.")) {
                ...
                fetch('handlers/archive-task-handler.php', {
                    ...
                    body: `taskID=${encodeURIComponent(taskID)}&archivedBy=${encodeURIComponent(currentUserID)}`
                })
