...
<html lang="en">
    ...
    <link rel="stylesheet" href="styles/user-profile-settings.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="styles/global.css?v=<?php echo time(); ?>">
    <title>User Profile Settings | PharmaScan</title>
                ...
                <div class="panels-container">
                    ...
                    <div class="options-panel">
                        ...
                        <div class="options-container">
                            <a href="user-profile-settings.php" class="options active">Profile Information</a>
                            <a href="user-account-settings.php" class="options">Account Settings</a>
                        </div>
                    </div>
                </div>
            </div>
